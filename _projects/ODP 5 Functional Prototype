---
layout: project
title: 2. First Functional Prototype For Open Design Project
description:
technologies:
image: /assets/images/odpfirstprototype.png
images:
  - /assets/images/odpfirstprototype.png
  - /assets/images/odp5sketch.png
  - /assets/images/odp5aperture.png
  - /assets/images/odp5assembly.png
  - /assets/images/componentslistp1.png
  - /assets/images/componentslistp2.png
toc: True
---


This prototype acts as our first concept to tackling the issue with spotted lanternflies found in grape collection bins. The purpose of this device is to sit above conveyor belts and suck up any materials other than grapes that pass by. The suction power on the nozzle can be tweaked to ensure that no grapes get captured and the materials that do get captured are spun in a cylone, down into a collection bag.
...
5. Create a stand using wooden beams
  ...
  5a. Use three wood planks to make a U shape. The horizontal plank is 14 inches wide to match the width of a standard conveyor belt.


  5b. Glue the vertical beams to the horizontal base and side of cyclone


  5c. Attach clamps to the horizontal base
...
### Design Tests
**1. What is the maximum distance and aperture diameter above the conveyor belt such that it can suck up 2-3 grams?**
